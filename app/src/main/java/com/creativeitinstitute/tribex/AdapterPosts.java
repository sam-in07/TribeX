...
public class AdapterPosts extends RecyclerView.Adapter<AdapterPosts.MyHolder>{
    ...
    public void onBindViewHolder(@NonNull final MyHolder holder, final int position) {
        // Get data from the ModelPost object at the current position
        ...
        // Format the time using Calendar and DateFormat
        ...
        // Set likes and handle like button click
        ...
        holder.likebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (adapterPosition != RecyclerView.NO_POSITION) {
                    final int plike = Integer.parseInt(modelPosts.get(adapterPosition).getPlike());
                    mprocesslike = true;
                    final String postid = modelPosts.get(adapterPosition).getPtime();
        ...
        holder.like.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (adapterPosition != RecyclerView.NO_POSITION) {
                    ...
                    intent.putExtra("pid", modelPosts.get(adapterPosition).getPtime());
        ...
        holder.more.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                int adapterPosition = holder.getAdapterPosition();
                if (adapterPosition != RecyclerView.NO_POSITION) {
                    showMoreOptions(holder.more, modelPosts.get(adapterPosition).getUid(), myuid, modelPosts.get(adapterPosition).getPtime(), modelPosts.get(adapterPosition).getUimage());
                }
            }
        });
